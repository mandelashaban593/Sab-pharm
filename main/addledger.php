...
<input type="hidden" name="name" value="<?php if(isset($_GET['invoice']))  echo $_GET['invoice']; ?>" />
<input type="hidden" name="invoice" value="<?php echo $finalcode; ?>" />
<input type="hidden" name="tot" value="<?php if(isset($_GET['amount']))  echo $_GET['amount']; ?>" />
<div id="ac">
