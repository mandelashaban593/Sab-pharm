...
<form action="savemedorder.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Order Medicine</h4></center>
<hr>
<div id="ac">
...
<span>Medicine Name : </span> <input type="text" id="searchword" name="searchword" placeholder="Enter Medicine name"  autocomplete="off" />
