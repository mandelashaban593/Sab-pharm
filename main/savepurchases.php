...
/*
   ...
   // echo "Number of rows retrieved: $numRows";
    ...
    $query = mysqli_query($con, "SELECT * FROM products WHERE batch_no= '$batchno' and med_name='$mednam' ") or die(mysqli_error($con));
   ...
   // echo "Number of rows retrieved: $numBatch";
    ...
    if ($numBatch > 0) {
        ...
        $sql = "INSERT INTO purchases_ret (invoice_number,cashier,date,type,amount,profit,due_date,name, tme,productid,total,pay_type,quantity,exp_date,batch_no,suplier_id, med_name) VALUES ('$invoice','$cashier','$date','$ptype','$pri','$profit2',CURDATE(),'$cname',CURTIME(), '$prodid', '$amt', '$ptype', '$qty', '$expirydate', '$batchno', '$suplier_id', '$med_name3')";
        $q = mysqli_query($con, $sql) or die(mysqli_error($con));
