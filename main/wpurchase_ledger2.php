...
<tr  class='record clickable-row' data-href='wpurchaseprint.php?invoice_number=<?php echo $row['invoice_number']; ?>'>
<?php } else if($row['vouch_type']=='Credit Note') { ?>

    <tr  class='record clickable-row' data-href='wsaleretprint.php?invoice=<?php echo $row['return_invoice']; ?>'>
<?php
