...
<?php } ?>  
    ...
    <div class="contentheader">
            ...
            <li class="active">Retail Sale Purchase return</li>
            </ul>
<div id="maintable">
...
<form id="productForm" method="post" action="saveretpurchreturn.php" style="width:250px;margin-top: 50px;">
...
function checkQuantity(inputElement, errorId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'wcnpurchcheck_quantity.php',
 ...
 <script>
        function updateDropdown(input) {
            ...
            fetch('fetch_retcnpurchitems_suggestions.php', {
                method: 'POST',
            ...
            .then(data => {
                ...
                data.forEach(suggestion => {
                    ...
                    suggestionItem.onclick = function() {
                        ...
                        row.cells[1].getElementsByTagName("input")[0].value = suggestion.quantity;
                        row.cells[2].getElementsByTagName("input")[0].value = suggestion.amount;
                        row.cells[3].getElementsByTagName("input")[0].value = suggestion.total;
