...
<?php } ?>  
    ...
    <div class="contentheader">
            ...
            <li class="active">Whole sale purchases</li>
            </ul>
<div id="maintable">
...
<form id="productForm" method="post" action="savewpurchases.php" style="width:250px;margin-top: 50px;">
        ...
        <input type="hidden" name="cashier" value="<?php echo $_SESSION['SESS_LAST_NAME']; ?>" />
                <table><tr><td>
       <input type="text" name="invoice" placeholder="Enter invoice Number" required/></td><td>
       <input type="date" name="date" placeholder="Date" required/></td><td>
        ...
        <td>
        <select  name='pay_type' style='width:90px' required><option value='cash'>Cash</option><option value='credit'>Credit</option></select>
    </td></tr></table>
