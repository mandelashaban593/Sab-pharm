...
<?php } ?>  
    ...
    <div class="contentheader">
            ...
            <li class="active">Whole Sale Purchase return</li>
            </ul>
<div id="maintable">
...
<form id="productForm" method="post" action="savewpurchreturn.php" style="width:250px;margin-top: 50px;">
...
function checkQuantity(inputElement, errorId) {
 ...
 <script>
        function updateDropdown(input) {
            ...
            fetch('fetch_wcnpurchitems_suggestions.php', {
                method: 'POST',
