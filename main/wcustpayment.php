...
<div>
	...
	$resulta = $db->prepare("SELECT sum(credit) as total FROM  customer_credit WHERE customer_id= :customer_id");
	$resulta->bindParam(':customer_id', $custid);
	$resulta->execute();
...
<a rel="facebox" href="addwholecustpay.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add  Payment</button></a><br><br><br><br><br><br><br><br>
