...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center><div style="font:bold 25px 'Aleo';margin-bottom: 20px;">Wholesale Payment Receipt</div>
Ojinga Pharmacy	<br>
	Jinja,Uganda	<br>	<br>
	</center>
	<div>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				<?php
					...
					$result = $db->prepare("SELECT * FROM  wcredit_payhist WHERE transaction_id= :userid");
					$result->bindParam(':userid', $id);
					$result->execute();
					for($i=0; $row = $result->fetch(); $i++){
				?>
				...
				<tr>
					...
					$resultas = $db->prepare("SELECT sum(cash) FROM wcredit_payhist WHERE transaction_id= :a");
