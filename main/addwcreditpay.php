...
<form action="savesupwpayment.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Add Payment</h4></center>
<hr>
<div id="ac">
<span> </span><input type="hidden" style="width:265px; height:30px;" name="suplier_id" value="<?php echo $_SESSION['suplier_id']; ?>" required/><br>
<span>Type: </span>
