...
<form id="productForm" method="post" action="savepurchreverse.php" style="width:150px;margin-top: 50px;">
                ...
                <tbody id="table-body">
                    <tr>
                        ...
                        <td>
                          ...
                          <td>
                            <input type="number" name="quantity[]" class="quantity_input" placeholder='Quantity' required>
                        </td>
                          <td>
                            <input type="text" name="price[]" class="price_input" placeholder='Rate' style="width:90px" required>
                        </td>
                          <td>
                            <input type="text" name="amount[]" class="amount_input" placeholder='Amount' onchange="calculateRate(this)" required>
                        </td>
    ...
    <script>
        function updateDropdown(input) {
            ...
            fetch('fetch_purchase_medicine.php', {
                method: 'POST',
