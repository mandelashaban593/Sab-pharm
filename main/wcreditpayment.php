...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-group"></i> Whole sale Credit pay
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="active">Whole sale Credit pay</li>
			</ul>
...
<div>
	...
	$resulta = $db->prepare("SELECT sum(credit) as total FROM wpurch_revenue WHERE suplier_id= :suplier_id");
...
<a rel="facebox" href="addwcreditpay.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add  Payment</button></a><br><br><br><br><br><br><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
				...
				<?php
				$resulta = $db->prepare("SELECT * FROM wcredit_payhist WHERE suplier_id= :suplier_id");
