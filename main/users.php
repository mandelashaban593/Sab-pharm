...
<a rel="facebox" href="addusers.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Users</button></a><br><br><br/><br><br><br/>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['position']; ?></td>
						...
						<td><a rel="facebox" title="Click to edit the product" href="edituser.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
