...
<span>Contact No. : </span><input type="text" style="width:265px; height:30px;" name="suplier_contact" /><br>
<span>Location: </span><input type="text" style="width:265px; height:30px;" name="location" Required/><br>
<span>Address : </span><input type="text" style="width:265px; height:30px;" name="suplier_address" /><br>
