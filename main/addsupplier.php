...
<hr>
<div id="ac">
<span>Supplier Username: </span><input type="text" style="width:265px; height:30px;" name="name" required/><br>
<span>Business Name: </span><input type="text" style="width:265px; height:30px;" name="businessname" required/><br>
...
<span>Contact No. : </span><input type="text" style="width:265px; height:30px;" name="work_contact" /><br>
