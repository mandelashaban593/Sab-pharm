...
$result = $db->prepare("SELECT COUNT(*) as total FROM cust_payhist  WHERE transaction_id  = :transaction_id");
...
try {
    ...
    $recordCount = 1;
        ...
        $records = $db->prepare("SELECT * FROM cust_payhist  WHERE transaction_id = :transaction_id ");
