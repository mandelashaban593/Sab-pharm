...
<div class="topnav">
  ...
  <a href="medallowance.php" class="active">Medical Allowance</a>
  <a href="advancepay.php">Advance Payment</a>
</div>


<?php 
				$result = $db->prepare("SELECT * FROM medical_allowance ORDER BY allowance_id DESC");
				$result->execute();
...
<a rel="facebox" href="addmedAllowance.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Allowance</button></a><br><br><br><br><br><br><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['allowance_date']; ?></td>
	
			<td><a rel="facebox" href="editmedallow.php?id=<?php echo $row['allowance_id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a>
