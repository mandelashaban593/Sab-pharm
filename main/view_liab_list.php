...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="25%"> Name</th>
			<th width="25%"> Liability Catagory</th>
	...
	<tbody>
			...
			<td><?php
			echo $rrrrrrr=$row['entry_date'];
			?></td>
			<td><?php
			echo $rrrrrrr=$row['transaction_id'];
			?></td>
			...
			<tr>
				...
				$resultas = $db->prepare("SELECT sum(amount) FROM liabilities  WHERE transaction_id= :a");
