...
<?php 
$result = $db->prepare("SELECT * FROM wcategory ORDER BY category_id DESC");
$result->execute();
...
<a rel="facebox" href="addwcategory.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Category</button></a><br><br><br/>
...
$status = 'Active';
$result = $db->prepare("SELECT * FROM wcategory  WHERE cat IS NOT NULL");
// Bind the parameter
$result->execute();
