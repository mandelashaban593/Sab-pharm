...
?>
	...
	<div class="contentheader">
			...
			<li class="active"> Wholesale Balance Sheet  Ledger</li>
			</ul>
<div id="maintable">
...
<div class="balance-sheet">
        <div class="balance-sheet-section">
            ...
            <ul>
                ...
                ?>
                    <li><?php echo $row['name'] . ': UGX ' . formatMoney($row['total']); ?></li>
                <?php
                }
                ?>
                <li>Total Assets: UGX <?php echo formatMoney($total_assets); ?></li>
            </ul>
        </div>
        <div class="balance-sheet-section">
            <h2>Liabilities</h2>
            <ul>
                ...
                ?>
               <li>Total Liabilities: UGX <?php echo formatMoney($total_liabilities); ?></li>
            </ul>
        </div>
        <div class="balance-sheet-section">
            <h2>Equity</h2>
            <ul>
                ...
                ?>
                <li>Total Equity: UGX <?php echo formatMoney($total_equity); ?></li>
            </ul>
        </div>
    </div>
