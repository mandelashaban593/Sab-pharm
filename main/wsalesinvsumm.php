...
if(isset($_GET['invoice_number'])) {
    ...
    ?>
<a  href="exportsalesreport.php?invoice_number=<?php echo  $invoice_number; ?>" style="float:right;" class="btn btn-info"><i class="icon-print icon-large"></i> Export</a>
<?php } ?>
...
<?php
    ...
    echo $invoice_number;
    $sql = "SELECT * FROM wsales WHERE   invoice_number = :invoice_number";
    $stmt = $db->prepare($sql);
...
$sql = "SELECT sum(amount*quantity) as total FROM wsales WHERE   invoice_number = :invoice_number";
$stmt = $db->prepare($sql);
$stmt->bindParam(':invoice_number', $invoice_number);
$stmt->execute();
