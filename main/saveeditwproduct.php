...
$q = mysqli_query($con, "SELECT * FROM wproducts WHERE batch_no ='$batch_no' ") or die(mysqli_error($con));
$rowcount_prod=mysqli_num_rows($q);


$result = $db->prepare("SELECT * FROM wproducts WHERE batch_no= :batch_no");
