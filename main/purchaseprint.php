...
{
    $result = $db->prepare("SELECT * FROM purchases_ret WHERE invoice_number = :invoice_number LIMIT :start, :perPage");
...
$result = $db->prepare("SELECT COUNT(*) as total FROM purchases_ret WHERE invoice_number = :invoice");
