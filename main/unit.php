...
<?php 
$result = $db->prepare("SELECT * FROM unit ORDER BY unit_id DESC");
$result->execute();
...
<a rel="facebox" href="addunit.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Unit</button></a><br><br><br/>
...
<a rel="facebo" href="category.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Category</button></a><br><br><br/>
...
$status = 'Active';
$result = $db->prepare("SELECT * FROM unit  WHERE unit IS NOT NULL");
// Bind the parameter
$result->execute();
...
<td><a rel="facebox" title="Click to edit the category" href="editunit.php?id=<?php echo $row['unit_id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
