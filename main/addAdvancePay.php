...
<form action="save_advancedpay.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Add Advanced Payment</h4></center>
<hr>
<div id="ac">
...
<span>Amount: </span><input type="number" style="width:265px; height:30px;" name="amount" id="amount" required/><br>
