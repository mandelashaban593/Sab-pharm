...
<select name="pay_type" style="width: 290px; height:30px;" class="chzn-select" required>
<option value="cash">Cash<option>
<option value="credit">Credit<option>
</select>

<input type="number" name="cash" placeholder="Enter Cash paid" style="width: 268px; height:30px;  margin-bottom: 15px;"   required/><br>
