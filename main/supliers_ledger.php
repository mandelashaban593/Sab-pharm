...
<?php } ?>
			...
			$resulta = mysqli_query($con, "SELECT sum(qty) as value_sum FROM products ") or die(mysqli_error($resulta));
			...
			$resulta = mysqli_query($con,"SELECT sum(qty*price) as value_sum FROM products ORDER BY product_id DESC ") or die(mysqli_error($resulta));
			$row_sum = mysqli_fetch_assoc($resulta);
