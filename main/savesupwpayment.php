...
echo "Sup name: $suplier_name<br>";
 ...
 try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $updateQuery = "UPDATE wpurch_revenue  SET credit = credit - :credit WHERE suplier_id = :suplier_id";
...
try {
    ...
    $sql = "INSERT INTO wcredit_payhist (suplier_id,suplier_name,cash,pay_type,date) VALUES (?, ?, ?, ?, ?)";
...
header("location: wpaypreview.php?id=$lastInsertedId&suplier_id=$suplier_id");
exit();
