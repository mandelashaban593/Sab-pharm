...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['work_contact']; ?></td>
			<td><?php echo $row['note']; ?></td>
			<td><?php echo $row['position']; ?></td>


			<td><a rel="facebox" title="Click to edit the suplier" href="editsupplier.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
			<a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click to Delete the suplier"><button class="btn btn-danger"><i class="icon-trash"></i></button></a></td>
			</tr>
			<?php
				}
			?>
