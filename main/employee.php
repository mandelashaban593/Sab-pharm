...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="17%"> Tin</th>
			<th width="17%"> Housing Allowance</th>
			<th width="17%"> Transport Allowance</th>
	...
	<tbody>
			...
			<td><?php echo $row['higheduc']; ?></td>
			<td><?php echo $row['sal']; ?></td>
			<td><?php echo $row['tin']; ?></td>
			<td><?php echo $row['hallowance']; ?></td>
			<td><?php echo $row['transpallowance']; ?></td>
