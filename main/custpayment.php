...
<div>
	...
	$resulta = $db->prepare("SELECT sum(credit) as total FROM  retcustomer_credit WHERE customer_id= :customer_id");
...
<a rel="facebox" href="addcustpay.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add  Payment</button></a><br><br><br><br><br><br><br><br>
