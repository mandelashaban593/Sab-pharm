...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br><br/>
...
<th width="12%"> Produt Name </th>
<th width="14%"> Number of bags</th>
<th width="14%"> Weight Note Number</th>
<th width="13%"> Delivery Note Number </th>
<th width="13%"> Deduction on bags </th>
<th width="13%"> Recommended moisture Content </th>
<th width="13%"> Actual Moisture Content</th>
<th width="6%"> Gross QTY </th>
<th width="6%"> Net weight </th>
<th width="6%"> Chaff </th>
<th width="6%"> Moisture Content Deduction </th>
...
<td><?php echo $row['numbags']; ?></td>
<td><?php echo $row['weight_no']; ?></td>
<td><?php echo $row['delivery_notenum']; ?></td>
<td><?php echo $row['deduct_no']; ?></td>
<td><?php echo $row['remm_mositure']; ?></td>
<td><?php echo $row['actual_moist']; ?></td>
<td><?php echo $row['qty']; ?></td>
<td><?php echo $row['net_weight']; ?></td>
<td><?php echo $row['chaff']; ?></td>
<td><?php echo $row['mois_cont_deduc']; ?></td>
