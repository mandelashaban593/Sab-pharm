...
<form id="productForm" method="post" action="savewholesalereturn.php" style="width:250px;margin-top: 50px;">
...
function checkQuantity(inputElement, errorId) {
 ...
 <script>
        function updateDropdown(input) {
            ...
            fetch('fetch_wcnitems_suggestions.php', {
                method: 'POST',
